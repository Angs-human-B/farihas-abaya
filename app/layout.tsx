...
export const metadata: Metadata = {
  ...
  description:
    "Discover exquisite handcrafted abayas where Arabian heritage meets modern elegance. Premium luxury collection featuring traditional and contemporary designs.",
  keywords:
    "abaya, luxury abaya, premium abaya, Arabic fashion, Islamic clothing, Dhaka, Bangladesh, traditional wear, modest fashion",
  ...
  openGraph: {
    ...
    description:
      "Where Arabian heritage meets modern elegance. Discover our exquisite collection of handcrafted premium abayas.",
